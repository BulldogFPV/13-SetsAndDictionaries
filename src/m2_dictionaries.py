...
contact_info = {
    "name": "Billy Joe",
    "phone": "912-345-678",
    "email": "greendayband@gmail.com",
    "address": "7894 Rock 'n Roll Drive"
}
print(contact_info)
###############################################################################
# Done: 2. (2 pts)
...
#   Once you have done this, then change the above _TODO_ to DONE.
###############################################################################
contact_info.update({"name": "Dave Grohl"})
print(contact_info)
###############################################################################
# Done: 4. (2 pts)
#   
...
#   Once you have done this, then change the above _TODO_ to DONE.
###############################################################################
contact_info.update({"birthday": "July 19, 1994"})
print(contact_info)
###############################################################################
# Done: 5. (2 pts)
#   
...
#   Once you have done this, then change the above _TODO_ to DONE.
###############################################################################
updated_contact_info = contact_info.copy()
